...
import { ArrowRight, Clock, FileCheck2, ShieldCheck, Database, Cpu, Layers, GitBranch, ArrowUpRight, BarChart3, AlertCircle } from "lucide-react";
    ...
    <section id="flagship-research" className="py-14 sm:py-18 bg-white border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <div className="rounded-2xl border-2 border-slate-300/80 bg-white p-6 sm:p-8 lg:p-10 shadow-xs hover:border-blue-900/50 transition-all duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              <div className="lg:col-span-7 space-y-4">
                ...
                <div className="pt-2">
                  <Link
                    href="/projects/task-aware-traffic-sign-classification"
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-md text-xs font-semibold text-white bg-slate-900 hover:bg-blue-950 transition-colors shadow-xs"
                  >
              ...
              <div className="lg:col-span-5 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div className="p-3.5 rounded-lg bg-white border border-slate-200">
                    ...
                    <span className="font-bold text-slate-800 text-sm">11,000 Images</span>
                  ...
                  <div className="p-3.5 rounded-lg bg-white border border-slate-200">
                    ...
                    <span className="font-bold text-slate-800 text-sm">50 Runs</span>
        ...
        <div className="mt-14 pt-10 border-t-2 border-dashed border-slate-200">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50/40 p-6 sm:p-8 hover:bg-white hover:border-slate-300 transition-all duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-4 space-y-3 text-xs">
                ...
                <div className="p-3 rounded-lg bg-white border border-slate-200 text-[11px] text-slate-500">
